...
Следует обратить внимание, что точка $r = 0$ для рассматриваемого уравнения (\autoref{eq:schrodinger_radial}) является особой. Из соотношения \autoref{eq:wavefunc_decomp} и требования непрерывности волновой функции всюду в пространстве следует, что $u_n(0) = 0$. Из симметрии задачи и требования непрерывности производной волновой функции следует, что $w_n'(0) = 0$, т.е. $w_n(r)$ при $r = 0$ имеет максимум или минимум. С учетом $u_n(0) = 0$ оно влечет $u_n'(0) = 0$. Кроме того, всегда справедливо $u_n(\infty) = 0$.
...
u_n(r) &= \rho(r) \sin \phi(r) \\
u_n'(r) &= \rho(r) \cos \phi(r) \textrm{,}
